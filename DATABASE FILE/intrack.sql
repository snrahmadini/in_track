...
INSERT INTO `attendance` (`id`, `username`, `employee_id`, `division_id`, `in_time`, `notes`, `image`, `lack_of`, `in_status`, `out_time`, `out_status`) VALUES
...
INSERT INTO `employee` (`id`, `name`, `email`, `gender`, `image`, `birth_date`, `hire_date`) VALUES
...
--
-- Struktur dari tabel `employee_division`
--
...
--
-- Dumping data untuk tabel `employee_division`
--

INSERT INTO `employee_division` (`id`, `employee_id`, `division_id`) VALUES
                                                                             (1, 001, 'HRD'),
                                                                             (2, 002, 'ACD'),
                                                                             (3, 003, 'QCD'),
                                                                             (4, 004, 'SCD'),
...
INSERT INTO `user_submenu` (`id`, `menu_id`, `title`, `url`, `icon`, `is_active`) VALUES
                                                                                      ...
                                                                                      (3, 2, 'Employee', 'master/employee', 'fas fa-fw fa-id-badge', 1),
...
--
-- Indeks untuk tabel `employee_division`
--
ALTER TABLE `employee_division`
    ADD PRIMARY KEY (`id`),
    ADD KEY `employee_division_ibfk_1` (`employee_id`),
    ADD KEY `employee_division_ibfk_2` (`division_id`);
...
--
-- AUTO_INCREMENT untuk tabel `employee_division`
--
ALTER TABLE `employee_division`
